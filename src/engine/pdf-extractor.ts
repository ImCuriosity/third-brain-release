...
// eslint-disable-next-line @typescript-eslint/no-require-imports, no-undef -- pdfjs-worker-inline is a virtual esbuild module that embeds the worker as a string; inlined at build time, not a runtime Node.js call
