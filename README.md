...
3. Click **⊕ Graph** to open the filtered graph view for any folder
4. Click **🔍 Analyze** to get a synthesized insight report for a folder
5. Click **🌉 Bridge** to find cross-folder connections
...
2. 입력 영역에 텍스트를 붙여넣고 **✦ 생성** 클릭 → 파이프라인 실행
3. **⊕ 그래프** 로 폴더 그래프 뷰 열기
4. **🔍 분석** 으로 폴더 종합 인사이트 리포트 확인
5. **🌉 연결** 로 폴더 간 브릿지 탐색
